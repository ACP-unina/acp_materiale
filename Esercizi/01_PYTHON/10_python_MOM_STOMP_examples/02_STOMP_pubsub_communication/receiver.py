...
if __name__ == "__main__":
    ...
    # Per la creazione di un subscriber durable è necessario impostare il flag di persisten=True e impostare
    # l'header della subscription con il valore {"activemq.subscriptionName":"testsub_durable"}

    #conn.subscribe(destination='/topic/mytesttopic', id=1, ack='auto', persistent=True, headers = {"activemq.subscriptionName":"testsub_durable"}) 
    conn.subscribe(destination='/topic/mytesttopic', id=1, ack='auto', persistent=True, 
